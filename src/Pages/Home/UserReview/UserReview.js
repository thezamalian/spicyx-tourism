...
const UserReview = () => {
    return (
        <div>
            ...
            <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 pb-5 mx-3" >

                <div class="col">
                    <div class="card card-cover h-100 bg-warning overflow-hidden rounded-5 shadow-lg"  >
